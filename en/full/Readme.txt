...
(1) Examples for worksheet functions (WS folder)
  ...
  XLPack Worksheet add-in must have been installed.

  Sample_Alg_Eq_5.xlsx		Algebraic equations
  Sample_Eigen_5.xlsx		Eigenvalues and eigenvectors
  Sample_FFT_5.xlsx		FFT
...
(2) Examples for VBA functions (VBA folder)

  Sample_Eigen_6.0.xlsm		Eigenvalues and eigenvectors
  Sample_FFT_5.xlsm		FFT (power spectrum)
  Sample_Int_Quad_5.4.xlsm	Interpolation and quadrature
  Sample_LinEq_5.xlsm		System of linear equations
  Sample_LinLS_6.0.xlsm		Linear least squares problems
...
---
Notices
- These sample worksheets are provided to show how to use XLPack, and these
  samples have not been thoroughly tested under all conditions. Therefore, the
  function, performance, or reliability of these samples are not guaranteed.
